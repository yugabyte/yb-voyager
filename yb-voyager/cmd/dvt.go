...
func dvtColumnCommandFn(cmd *cobra.Command, args []string) {
	...
	sourceTableListStr := "public.active_admin_comments,public.active_storage_attachments,public.alerts,public.adjustments,public.users,public.allowed_states,public.ar_internal_metadata,public.audits,public.active_storage_blobs,public.balances,public.blocks,public.campaign_codes,public.codes,public.bonus_offers,public.community_plays,public.exclusions,public.free_picks,public.correlated_entry_payouts,public.payments,public.new_wagers,public.duration_leagues,public.fish,public.free_entry_reasons,public.game_types,public.scores,public.new_players,public.leagues,public.projection_filters,public.projections,public.withdrawal_requests,public.league_icons,public.invites,public.league_maxes,public.league_max_rulesets,public.league_positions,public.league_projection_filters,public.nfl_team_viz,public.memberships,public.odds,public.payout_boosts,public.player_count_rulesets,public.players,public.positions,public.promotion_tiers,public.promotion_users,public.payload_hashes,public.rulesets,public.ruleset_player_counts,public.referral_partners,public.self_exclusions,public.self_timeouts,public.rules,public.schema_migrations,public.providers,public.service_terms,public.sharks,public.unsettlements,public.unsettlement_actions,public.source_ads,public.transactions,public.tsevo_session_responses,public.upload_checksums,public.sign_in_coords,public.user_payment_options,public.user_notes,public.wagers,public.web_callbacks,public.whales,public.admin_users,public.promotions,public.predictions,public.active_storage_variant_records,public.board_error_reasons,public.bonus_codes,public.challenge_users,public.challenges,public.discord_profiles,public.f2p_contest_results,public.limits,public.logical_schema_migrations,public.member_transactions,public.refund_requests,public.rewards,public.settle_locks,public.socure_responses,public.user_segments,public.vpn_detections,public.vpn_features,public.vpn_ip_addresses"
	sourceTableList := strings.Split(sourceTableListStr, ",")
