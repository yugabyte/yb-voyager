...
var importDataToSourceReplicaCmd = &cobra.Command{
	...
	Short: "Import data into source-replica database to prepare for fall-forward.\n" +
		"For more details and examples, visit https://docs.yugabyte.com/preview/yugabyte-voyager/reference/data-migration/import-data/#import-data-to-source-replica",
	Long: ``,
