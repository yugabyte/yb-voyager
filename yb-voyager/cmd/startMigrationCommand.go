...
func init() {
	...
	startMigrationCmd.Flags().StringVarP(&startMigrationConfigFile, "config", "c", "",
		"path to the config file generated by 'yb-voyager init'")
	startMigrationCmd.MarkFlagRequired("config")
...
func printStartMigrationNextSteps(configFilePath string, v *viper.Viper, workflow string) {
	...
	fmt.Printf("     yb-voyager export schema --config %s\n\n", configFilePath)
