...
func init() {
	...
	//Keeping the default as false here as the the default value as false, 0 etc.. is not added to the usage msg by cobra and as the flag is mandatory there is no default value. 
