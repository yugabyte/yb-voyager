...
func hideFlagsInFallForwardOrBackCmds(cmd *cobra.Command) {
	var flags = []string{"target-db-type", "import-type", "source-db-type", "export-type", "target-endpoints", "use-public-ip", "continue-on-error", "table-list",
