...
var fallbackStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "Prints status of the fall-back switchover",
	Long:  `Prints status of the fall-back switchover`,
...
func init() {
	fallBackCmd.AddCommand(fallbackStatusCmd)
	fallbackStatusCmd.Flags().StringVarP(&exportDir, "export-dir", "e", "",
