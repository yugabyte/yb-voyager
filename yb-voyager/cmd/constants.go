...
const (
	...
	REFERENCING_CLAUSE_TRIGGER_DOC_LINK           = DOCS_LINK_PREFIX + POSTGRESQL_PREFIX + "#<TODO>"
	BEFORE_ROW_TRIGGER_PARTITIONED_TABLE_DOC_LINK = DOCS_LINK_PREFIX + POSTGRESQL_PREFIX + "#<TODO>"
