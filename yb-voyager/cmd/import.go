...
func registerImportDataFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&tconf.ExcludeTableList, "exclude-table-list", "",
		"comma separated list of tables names or regular expressions for table names to exclude while importing data")
	cmd.Flags().StringVar(&tconf.TableList, "table-list", "",
		"comma separated list of tables names or regular expressions for table names to import data")
