...
func init() {
	...
	// finds no conflicts. Artifacts generated by OLDER exporters lack the
	// multi-column metadata key entirely and fail loudly at conflict-cache
	// initialization — regenerate with a current binary (CDCBENCH_REGEN=1).
	Register(Workload{
