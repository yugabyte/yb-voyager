# anon (SQL Anonymizer) Package — Engineering Standards

> **Scope:** files under `yb-voyager/src/anon/`. These are standards for **writing** code here, not only for reviewing it.
