# migassessment Package — Engineering Standards

> **Scope:** files under `yb-voyager/src/migassessment/`. These are standards for **writing** code here, not only for reviewing it.
