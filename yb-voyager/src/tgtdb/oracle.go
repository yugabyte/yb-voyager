...
func (tdb *TargetOracleDB) GetTableToUniqueIndexesMap(tableList []sqlname.NameTuple) (*utils.StructMap[sqlname.NameTuple, [][]string], error) {
...
func (tdb *TargetOracleDB) EnableGeneratedAlwaysAsIdentityColumns(tableColumnsMap *utils.StructMap[sqlname.NameTuple, []string]) error {
	...
	return tdb.alterColumns(tableColumnsMap, constants.ORACLE_GENERATED_ALWAYS_AS_IDENTITY)
}
