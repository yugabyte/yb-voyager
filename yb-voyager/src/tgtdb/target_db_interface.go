...
type TargetDB interface {
	...
	GetGeneratedAlwaysIdentityColumnNamesForTable(table string) ([]string, error)
	GetGeneratedAlwaysAsIdentityColumnsForTables(tables []string) (map[string][]string, error)
