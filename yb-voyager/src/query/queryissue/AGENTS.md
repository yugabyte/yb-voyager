# queryissue Package — Engineering Standards

> **Scope:** files under `yb-voyager/src/query/queryissue/`. These are standards for **writing** code here, not only for reviewing it.
