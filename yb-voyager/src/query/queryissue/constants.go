...
const (
	...
	GEOMETRY_DATATYPE_ISSUE_DESCRIPTION                              = "GEOMETRY datatype is not yet supported in YugabyteDB. Affected column: %s."
	GEOGRAPHY_DATATYPE_ISSUE_DESCRIPTION                             = "GEOGRAPHY datatype is not yet supported in YugabyteDB. Affected column: %s."
	BOX2D_DATATYPE_ISSUE_DESCRIPTION                                 = "BOX2D datatype is not yet supported in YugabyteDB. Affected column: %s."
	BOX3D_DATATYPE_ISSUE_DESCRIPTION                                 = "BOX3D datatype is not yet supported in YugabyteDB. Affected column: %s."
	TOPOGEOMETRY_DATATYPE_ISSUE_DESCRIPTION                          = "TOPOGEOMETRY datatype is not yet supported in YugabyteDB. Affected column: %s."
	RASTER_DATATYPE_ISSUE_DESCRIPTION                                = "RASTER datatype is not yet supported in YugabyteDB. Affected column: %s."
	PG_LSN_DATATYPE_ISSUE_DESCRIPTION                                = "PG_LSN datatype is not yet supported in YugabyteDB. Affected column: %s."
	TXID_SNAPSHOT_DATATYPE_ISSUE_DESCRIPTION                         = "TXID_SNAPSHOT datatype is not yet supported in YugabyteDB. Affected column: %s."
	...
	INT8_MULTIRANGE_DATATYPE_ISSUE_DESCRIPTION                 = "INT8MULTIRANGE data type is not yet supported in YugabyteDB. Affected column: %s."
	INT4_MULTIRANGE_DATATYPE_ISSUE_DESCRIPTION                 = "INT4MULTIRANGE data type is not yet supported in YugabyteDB. Affected column: %s."
	DATE_MULTIRANGE_DATATYPE_ISSUE_DESCRIPTION                 = "DATEMULTIRANGE data type is not yet supported in YugabyteDB. Affected column: %s."
	NUM_MULTIRANGE_DATATYPE_ISSUE_DESCRIPTION                  = "NUMMULTIRANGE data type is not yet supported in YugabyteDB. Affected column: %s."
	TS_MULTIRANGE_DATATYPE_ISSUE_DESCRIPTION                   = "TSMULTIRANGE data type is not yet supported in YugabyteDB. Affected column: %s."
	TSTZ_MULTIRANGE_DATATYPE_ISSUE_DESCRIPTION                 = "TSTZMULTIRANGE data type is not yet supported in YugabyteDB. Affected column: %s."
