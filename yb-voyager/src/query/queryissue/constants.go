...
const (
	...
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_XML     = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_XML"

	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_GEOMETRY       = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_GEOMETRY"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_GEOGRAPHY      = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_GEOGRAPHY"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_BOX2D          = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_BOX2D"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_BOX3D          = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_BOX3D"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TOPOGEOMETRY   = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TOPOGEOMETRY"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_RASTER         = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_RASTER"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_PG_LSN         = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_PG_LSN"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TXID_SNAPSHOT  = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TXID_SNAPSHOT"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_LARGE_OBJECT   = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_LARGE_OBJECT"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_INT4MULTIRANGE = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_INT4MULTIRANGE"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_INT8MULTIRANGE = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_INT8MULTIRANGE"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_NUMMULTIRANGE  = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_NUMMULTIRANGE"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TSMULTIRANGE   = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TSMULTIRANGE"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TSTZMULTIRANGE = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TSTZMULTIRANGE"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_DATEMULTIRANGE = "UNSUPPORTED_DATATYPE_LIVE_MIGRATION_DATEMULTIRANGE"
...
const (
	...
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_XML_ISSUE_NAME     = "Unsupported datatype for Live migration - xml"

	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_GEOMETRY_ISSUE_NAME       = "Unsupported datatype for Live migration - geometry"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_GEOGRAPHY_ISSUE_NAME      = "Unsupported datatype for Live migration - geography"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_BOX2D_ISSUE_NAME          = "Unsupported datatype for Live migration - box2d"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_BOX3D_ISSUE_NAME          = "Unsupported datatype for Live migration - box3d"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TOPOGEOMETRY_ISSUE_NAME   = "Unsupported datatype for Live migration - topogeometry"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_RASTER_ISSUE_NAME         = "Unsupported datatype for Live migration - raster"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_PG_LSN_ISSUE_NAME         = "Unsupported datatype for Live migration - pg_lsn"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TXID_SNAPSHOT_ISSUE_NAME  = "Unsupported datatype for Live migration - txid_snapshot"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_LARGE_OBJECT_ISSUE_NAME   = "Unsupported datatype for Live migration - lo"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_INT4MULTIRANGE_ISSUE_NAME = "Unsupported datatype for Live migration - int4multirange"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_INT8MULTIRANGE_ISSUE_NAME = "Unsupported datatype for Live migration - int8multirange"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_NUMMULTIRANGE_ISSUE_NAME  = "Unsupported datatype for Live migration - nummultirange"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TSMULTIRANGE_ISSUE_NAME   = "Unsupported datatype for Live migration - tsmultirange"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_TSTZMULTIRANGE_ISSUE_NAME = "Unsupported datatype for Live migration - tstzmultirange"
	UNSUPPORTED_DATATYPE_LIVE_MIGRATION_DATEMULTIRANGE_ISSUE_NAME = "Unsupported datatype for Live migration - datemultirange"
