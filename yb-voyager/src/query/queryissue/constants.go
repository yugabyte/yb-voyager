...
To address this issue and improve query performance, application-level sharding is recommended. Ensure that the range-sharding is also configured on this column.
