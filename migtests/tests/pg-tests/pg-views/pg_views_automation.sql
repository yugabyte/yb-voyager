...
drop table if exists view_table1 cascade;
...
drop table if exists view_table2 cascade;
...
create materialized view mv1 as select first_name,last_name from view_table1 where gender='Male' with data;

select * from mv1;

insert into view_table1 (first_name, last_name, email, gender, ip_address) values ('Kah', 'Loger', 'nmeecher9@quantcast.com', 'Male', '152.239.228.215');
