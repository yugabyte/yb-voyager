...
INSERT INTO empty_identity_demo_generated_by_def (description) VALUES ('Some value');

DELETE FROM empty_identity_demo_generated_by_def
WHERE id = 2;

INSERT INTO empty_identity_demo_generated_always (description) VALUES ('First Row');
INSERT INTO empty_identity_demo_generated_always (description) VALUES ('Second Row');

UPDATE empty_identity_demo_generated_always
...
DELETE FROM empty_identity_demo_generated_always
WHERE id = 2;