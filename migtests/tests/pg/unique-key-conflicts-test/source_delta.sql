...
-- Conflicts for same_column_unique_constraint_and_index
DELETE FROM same_column_unique_constraint_and_index WHERE id = 1;
INSERT INTO same_column_unique_constraint_and_index (id, email) VALUES (6, 'user1@example.com');  -- DELETE-INSERT conflict

DELETE FROM same_column_unique_constraint_and_index WHERE id = 2;
UPDATE same_column_unique_constraint_and_index SET email = 'user2@example.com' WHERE id = 3;  -- DELETE-UPDATE conflict

UPDATE same_column_unique_constraint_and_index SET email = 'updated_user4@example.com' WHERE id = 4;
INSERT INTO same_column_unique_constraint_and_index (id, email) VALUES (7, 'user4@example.com');  -- UPDATE-INSERT conflict

UPDATE same_column_unique_constraint_and_index SET email = 'updated_user5@example.com' WHERE id = 5;
UPDATE same_column_unique_constraint_and_index SET email = 'user5@example.com' WHERE id = 6;  -- UPDATE-UPDATE conflict

-- Public schema conflicts
