...
-- DELETE FROM "pg-schema".test WHERE id = 1002;

-- INSERT INTO "pg-schema".test (val) SELECT 'val' || n FROM generate_series(1001,1010) AS n;
-- UPDATE "pg-schema".test SET val = 'Updated Value 1' WHERE id = 1001;
-- UPDATE "pg-schema".test SET val = NULL WHERE id = 677;
-- DELETE FROM "pg-schema".test WHERE id = 998;
-- DELETE FROM "pg-schema".test WHERE id = 1002;
