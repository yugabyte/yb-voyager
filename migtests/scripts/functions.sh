...
grant_permission_to_target_user() {
  ...
  echo "-- GRANT SET ON PARAMETER session_replication_role" >> "${permissions_sql_file}"
  echo "GRANT SET ON PARAMETER session_replication_role TO ${TARGET_DB_USER};" >> "${permissions_sql_file}"  
