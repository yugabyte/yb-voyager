...
export TARGET_DB_USER=${TARGET_DB_USER:-"postgres"}
export TARGET_DB_PASSWORD=${TARGET_DB_PASSWORD:-'postgres'}
export TARGET_DB_ADMIN_USER=${TARGET_DB_ADMIN_USER:-"postgres"}
