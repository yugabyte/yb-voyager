...
/* Generated from: pg_query.proto */

#ifndef PROTOBUF_C_pg_5fquery_2eproto__INCLUDED
#define PROTOBUF_C_pg_5fquery_2eproto__INCLUDED
...
typedef enum _PgQuery__SortByDir {
  ...
  PG_QUERY__SORT_BY_DIR__SORTBY_HASH = 5
...
struct  PgQuery__Var
{
  ...
  int32_t vartypmod;
  uint32_t varcollid;
  size_t n_varnullingrels;
  uint64_t *varnullingrels;
...
struct  PgQuery__Query
{
  ...
  size_t n_rteperminfos;
  PgQuery__Node **rteperminfos;
...
#endif  /* PROTOBUF_C_pg_5fquery_2eproto__INCLUDED */
