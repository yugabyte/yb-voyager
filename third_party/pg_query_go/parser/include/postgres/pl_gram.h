...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    K_LOOP = 338,                  /* K_LOOP  */
    K_MERGE = 339,                 /* K_MERGE  */
    K_MESSAGE = 340,               /* K_MESSAGE  */
    K_MESSAGE_TEXT = 341,          /* K_MESSAGE_TEXT  */
    K_MOVE = 342,                  /* K_MOVE  */
    K_NEXT = 343,                  /* K_NEXT  */
    K_NO = 344,                    /* K_NO  */
    K_NOT = 345,                   /* K_NOT  */
    K_NOTICE = 346,                /* K_NOTICE  */
    K_NULL = 347,                  /* K_NULL  */
    K_OPEN = 348,                  /* K_OPEN  */
    K_OPTION = 349,                /* K_OPTION  */
    K_OR = 350,                    /* K_OR  */
    K_PERFORM = 351,               /* K_PERFORM  */
    K_PG_CONTEXT = 352,            /* K_PG_CONTEXT  */
    K_PG_DATATYPE_NAME = 353,      /* K_PG_DATATYPE_NAME  */
    K_PG_EXCEPTION_CONTEXT = 354,  /* K_PG_EXCEPTION_CONTEXT  */
    K_PG_EXCEPTION_DETAIL = 355,   /* K_PG_EXCEPTION_DETAIL  */
    K_PG_EXCEPTION_HINT = 356,     /* K_PG_EXCEPTION_HINT  */
    K_PG_ROUTINE_OID = 357,        /* K_PG_ROUTINE_OID  */
    K_PRINT_STRICT_PARAMS = 358,   /* K_PRINT_STRICT_PARAMS  */
    K_PRIOR = 359,                 /* K_PRIOR  */
    K_QUERY = 360,                 /* K_QUERY  */
    K_RAISE = 361,                 /* K_RAISE  */
    K_RELATIVE = 362,              /* K_RELATIVE  */
    K_RETURN = 363,                /* K_RETURN  */
    K_RETURNED_SQLSTATE = 364,     /* K_RETURNED_SQLSTATE  */
    K_REVERSE = 365,               /* K_REVERSE  */
    K_ROLLBACK = 366,              /* K_ROLLBACK  */
    K_ROW_COUNT = 367,             /* K_ROW_COUNT  */
    K_ROWTYPE = 368,               /* K_ROWTYPE  */
    K_SCHEMA = 369,                /* K_SCHEMA  */
    K_SCHEMA_NAME = 370,           /* K_SCHEMA_NAME  */
    K_SCROLL = 371,                /* K_SCROLL  */
    K_SLICE = 372,                 /* K_SLICE  */
