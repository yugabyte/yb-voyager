# debezium-server-voyager — Engineering Standards

> **Scope:** files under `debezium-server-voyager/`. These are standards for **writing** code here, not only for reviewing it.
