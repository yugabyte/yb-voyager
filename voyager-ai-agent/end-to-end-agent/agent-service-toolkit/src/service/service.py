...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    # try:
    #     from mcpservers.mcp_servers import load_mcp_tools
    #     await load_mcp_tools()
    #     from mcpservers.mcp_servers import get_mcp_tools
    #     print(f"MCP Tools: {get_mcp_tools()}")
    # except Exception as e:
    #     logger.error(f"Error during mcp tools initialization: {e}")
    #     raise
...
async def invoke(user_input: UserInput, agent_id: str = DEFAULT_AGENT) -> ChatMessage:
    ...
    #     voyager_agent = register_voyager_agent_with_mcp_tools_and_compile(mcp_tools)
    #     add_agent("voyager-agent", voyager_agent, "database migration assistant")
    # except Exception as e:
    #     logger.error(f"Error during mcp tools initialization: {e}")
    #     raise
